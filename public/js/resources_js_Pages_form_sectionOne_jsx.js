...
var Form = function Form() {
  ...
  var handleSubmit = function handleSubmit(event) {
    ...
    event.preventDefault();
    if ((Object === null || Object === void 0 ? void 0 : (_Object$values = Object.values) === null || _Object$values === void 0 ? void 0 : (_Object$values$call = _Object$values.call(Object, data)) === null || _Object$values$call === void 0 ? void 0 : _Object$values$call.length) > 0) {
      return (0,_components_helpers_helper__WEBPACK_IMPORTED_MODULE_2__["default"])('section.one.save', 'post', data, '', 'section.two.index').then(function (response) {
...
var save = function save(Route, method, data) {
  ...
  try {
    ...
    return (axios__WEBPACK_IMPORTED_MODULE_0___default())[method](ziggy_js__WEBPACK_IMPORTED_MODULE_2___default()(customRoute), {
      data: data
    }).then(function (response) {
      if (!!returnRoute) {
        _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia.get(ziggy_js__WEBPACK_IMPORTED_MODULE_2___default()(returnRoute));
      }
      return response;
    });
  } catch (error) {
...
var submitComponent = function submitComponent(_ref) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div", {
    children: [children && children, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", {
      ...
      className: "text-center pt-5",
      children: previousPage && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(_inertiajs_inertia_react__WEBPACK_IMPORTED_MODULE_0__.Link, {
        href: route(previous),
        preserveState: true,
        children: "Regresar"
      })
